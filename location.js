...
export const locations = {
  'Oakheart Village': {
    ...
    theme: 'town',
    flavorTexts: [
      "The forge’s embers glow alive as you pass, sending tiny sparks that dance like fireflies.",
      "A hollow clang rings out from the anvil, lingering in the air long after the hammer falls.",
      "Warm lantern light spills from the inn’s windows, promising comfort against the forest’s chill.",
      "The sweet tang of freshly baked bread drifts past you, weaving through the scent of hot iron.",
      "A trader’s muffled bargaining drifts from beneath striped awnings, each voice carrying its own accent.",
      "Beneath your boots, the cobblestones bear faint runic carvings, worn smooth by countless travelers.",
      "In the hush between blows, you catch the echo of wind through the ancient oaks overhead.",
    ],
  ...
  'Market Square': {
    ...
    theme: 'town',
    flavorTexts: [
      "Vendors haggle in lively bursts, their calls weaving into a tapestry of sound.",
      "Brightly striped awnings ripple overhead, painting the stalls in dappled hues.",
      "Baskets overflow with glistening apples, fragrant herbs, and glittering trinkets.",
      "A stray cart wheel squeaks as it rolls past barrels of spiced honey.",
      "Children dart between stalls, their laughter mingling with the chorus of trade.",
    ],
    npcs: ['town_merchant'],
    hostiles: [],
    loot: [],
  ...
  'Blacksmith Forge': {
    ...
    theme: 'town',
    flavorTexts: [
      "The roar of the forge fire warms your bones even before you step inside.",
      "Each hammer strike rings like a battle cry, echoing off soot-blackened walls.",
      "The scent of burning charcoal and molten metal hangs heavy in the air.",
      "Glowing coals send flickering shadows dancing across worn stone floors.",
      "A hiss and plume of steam rise as a red-hot blade meets the quenching barrel.",
    ],
  ...
  'The Sleepy Stoat': {
    ...
    theme: 'town',
    flavorTexts: [
      "Faint laughter and the clink of tankards drift from within the hearth-lit common room.",
      "The aroma of spiced stew and freshly baked bread greets you at the door.",
      "Soft lamplight pools on polished tables, revealing carved oak-leaf motifs.",
      "The crackling hearth whispers tales of long roads and shared tales.",
      "Well-worn floorboards creak underfoot as patrons settle into cozy corners.",
    ],
    npcs: ['innkeeper'],
    hostiles: [],
    loot: [],
